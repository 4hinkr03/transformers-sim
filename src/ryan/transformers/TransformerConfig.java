...
public class TransformerConfig {
	...
	public static final Location[] ALL_SPARK_LOCATIONS = { new Location(27, 3), new Location(27, 27), };

	public static final BlockArea[] BLOCK_AREAS = { new BlockArea(15, 8, 1, 15) };
